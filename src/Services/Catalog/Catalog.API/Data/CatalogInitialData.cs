        ...
        private static IEnumerable<Product> GetPreconfiguredProducts() => new List<Product>()
            {
                new Product()
                {
                    ...
                    Price = 950.00M,
                    CategoryList = new List<string> { "Smart Phone" }
                },
                new Product()
                {
                ...
                new Product()
                {
                    ...
                    Price = 650.00M,
                    CategoryList = new List<string> { "White Appliances" }
                },
                new Product()
                {
                ...
                new Product()
                {
                    ...
                    Price = 240.00M,
                    CategoryList = new List<string> { "Home Kitchen" }
                },
                new Product()
                {
                    ...
                    ImageFile = "product-6.png",
                    Price = 240.00M,
                    CategoryList = new List<string> { "Camera" }
                }
            };
